...
Recent agentic medical-imaging systems extend single-pass reasoning with memory, tools, retrieval, reflection, and iterative validation~\cite{tang2025endocogniagent,alim2026gaze,sayeedi2026route}. These capabilities may improve evidence acquisition, but they also create additional failure surfaces: an agent can store an unsupported observation, accept an inappropriate tool output, or preserve a misleading intermediate hypothesis~\cite{dash2026untrusted,zhang2026memmorph}. Existing clinical-agent benchmarks emphasise sequential decision-making and tool-assisted reasoning~\cite{jiang2025medagentbench,schmidgall2024agentclinic}; they do not, however, directly establish whether explanations and intermediate states remain causally linked to clinically relevant image evidence. This motivates an evaluation that tests visual dependence, explanation faithfulness, and confidence sensitivity together.
...
\bibliographystyle{AuthorKit27/aaai2027}
